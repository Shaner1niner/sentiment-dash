\# Public/member dashboard inventory v1
...
This surface should be treated as generated or publication-managed unless intentionally edited.
...
Prediction-accountability surfaces should remain accountability/review oriented. They should not be framed as trade instructions, targets, entries, exits, or recommendations.
...
\- evidence refresh health PASS means evidence payload/status/mounts are coherent.
