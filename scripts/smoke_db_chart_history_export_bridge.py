...
def main() -> int:
    script_text = require_text(
        ...
        [
            ...
            "DEFAULT_MIN_ROWS_PER_TERM",
            "DEFAULT_MIN_MEDIAN_ROWS_PER_TERM",
            "DEFAULT_MIN_DATE_SPAN_DAYS",
            "asset-source",
            ...
            "history_depth",
            "depth_guard",
            "terms_below_min_rows_sample",
            "DB chart-history depth guard failed",
            "--skip-depth-guard",
            "--min-rows-per-term",
            "--min-median-rows-per-term",
            "--min-date-span-days",
